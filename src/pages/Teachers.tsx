  ...
  const teachers = [
    {
      ...
      paragraphs: [
        "As Deputy Principal of Rubiri Senior School, I have witnessed countless transformations of young minds into brilliant scholars and responsible citizens. Our commitment to academic excellence is matched only by our dedication to nurturing well-rounded individuals who will lead tomorrow's world with integrity and compassion.",
        "Joining Rubiri Senior School means becoming part of a family that believes in your potential. We don't just teach subjects; we ignite passions, build character, and create opportunities for every student to shine. Your journey to success begins here, and we walk alongside you every step of the way."
      ]
    },
    {
      name: "Mr. Nyakundi",
    ...
    },
    {
      ...
      paragraphs: [
        "As a woman in education, I am passionate about empowering every student, regardless of their background, to reach for the stars. At Rubiri Senior School, we believe that education is the great equalizer, and we are committed to providing every student with the tools, resources, and encouragement they need to succeed.",
    ...
    },
    {
      ...
      paragraphs: [
        "At Rubiri Senior School, we understand that the path to success is not always smooth, but it is always worthwhile. Our supportive environment ensures that students feel safe to take risks, make mistakes, and learn from them. We build resilience and determination in our students, qualities that serve them well beyond the classroom.",
    ...
    },
    {
      ...
      paragraphs: [
        "Teaching is not just my profession; it is my calling. At Rubiri Senior School, I have the privilege of working with some of the brightest young minds in the country, and every day brings new opportunities to inspire and be inspired. Our approach to education goes beyond rote learning – we encourage critical thinking, creativity, and innovation.",
        "If you're looking for a school that will challenge you to be your best while supporting you every step of the way, Rubiri Senior School is the perfect choice. Our proven track record of academic excellence, combined with our nurturing environment, creates the ideal conditions for success. Join us and unlock your full potential."
      ]
    },
    {
      ...
      paragraphs: [
        "Every student who enters Rubiri Senior School brings with them unique talents, dreams, and potential. Our mission is to nurture these gifts and help each individual flourish. Through innovative teaching methods, personalized mentorship, and a genuine commitment to student success, we create an environment where excellence becomes a habit.",
        "The decision to join Rubiri Senior School is an investment in your future that pays dividends for a lifetime. Our graduates don't just succeed academically – they become leaders, innovators, and responsible citizens who make meaningful contributions to society. Be part of this legacy of excellence. Choose Rubiri, choose success, choose a brighter future."
      ]
    }
  ];
